...
train_dataset = load_dataset("yangwang825/rte", split="train")
val_dataset = load_dataset("yangwang825/rte", split="validation")
test_dataset = load_dataset("yangwang825/rte", split="test")

# Extracting 'text1' and 'text2' columns into a list of lists

train_text_data = list(zip(train_dataset['text1'], train_dataset['text2']))
val_text_data = list(zip(val_dataset['text1'], val_dataset['text2']))
test_text_data = list(zip(test_dataset['text1'], test_dataset['text2']))
...
# Save the best model
torch.save(best_model, f'RTE_best_model_tiny_fine-tuned_epoch_{best_epoch}_lr_{best_learning_rate}.pth')
...
# Save the best model
torch.save(best_model, f'RTE_best_model_mini_fine-tuned_epoch_{best_epoch}_lr_{best_learning_rate}.pth')
...
# Save the best model
torch.save(best_model, f'RTE_best_model_tiny_without_fine-tuning_epoch_{best_epoch}_lr_{best_learning_rate}.pth')
...
# Save the best model
torch.save(best_model, f'RTE_best_model_mini_without_fine-tuning_epoch_{best_epoch}_lr_{best_learning_rate}.pth')
